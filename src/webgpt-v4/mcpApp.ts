...
const readAnnotations = { readOnlyHint: true, openWorldHint: false, destructiveHint: false } as const;
const writeAnnotations = { readOnlyHint: false, openWorldHint: false, destructiveHint: false, idempotentHint: true } as const;
...
export function createWebGptV4McpApp(options: CreateWebGptV4McpAppOptions): McpServer {
  ...
  registerAppResource(server, "WebGPT V4 Media Inspector", WEBGPT_V4_WIDGET_URI, { description: "Project-scoped production media player." }, async () => ({
    contents: [{
  ...
  server.registerTool("list_production_projects", {
    ...
    _meta: { ...security("projects.read") }
  }, async (input) => guarded("projects.read", actor, authConfig, input.request_id, () => listProductionProjects(input, db, input.request_id)) as never);
  ...
  server.registerTool("get_project_context", {
    ...
    outputSchema: projectContextResultSchema, annotations: readAnnotations, _meta: { ...security("projects.read") }
  }, async (input) => guarded("projects.read", actor, authConfig, input.request_id, () => getProductionProjectContext(input, db, input.request_id)) as never);
  ...
  server.registerTool("list_project_shots", {
    ...
    outputSchema: shotListResultSchema, annotations: readAnnotations, _meta: { ...security("projects.read") }
  }, async (input) => guarded("projects.read", actor, authConfig, input.request_id, () => listProductionProjectShots(input, db, input.request_id)) as never);

  server.registerTool("list_project_media", {
    title: "列出项目媒体",
    ...
    outputSchema: mediaListResultSchema, annotations: readAnnotations, _meta: { ...security("media.read") }
  ...
  registerAppTool(server, "inspect_media", {
    title: "检查生产媒体",
  ...
  server.registerTool("get_review_package", {
    ...
    outputSchema: reviewPackageResultSchema, annotations: readAnnotations, _meta: { ...security("projects.read") }
  }, async (input) => guarded("projects.read", actor, authConfig, input.request_id, () => getProductionReviewPackage(input, db, input.request_id)) as never);
  ...
  server.registerTool("get_delivery_status", {
    ...
    inputSchema: { project_id: z.string(), request_id: z.string().max(128).optional() }, outputSchema: deliveryResultSchema, annotations: readAnnotations, _meta: { ...security("projects.read") }
  }, async (input) => guarded("projects.read", actor, authConfig, input.request_id, () => getProductionDeliveryStatus(input, db, input.request_id)) as never);
  ...
  server.registerTool("get_closeout_evidence", {
    ...
    inputSchema: { project_id: z.string(), request_id: z.string().max(128).optional() }, outputSchema: closeoutResultSchema, annotations: readAnnotations, _meta: { ...security("projects.read") }
  }, async (input) => guarded("projects.read", actor, authConfig, input.request_id, () => getProductionCloseoutEvidence(input, db, input.request_id)) as never);

  server.registerTool("update_shot_copy", {
    title: "更新 SHOT 文案",
    ...
    outputSchema: shotCopyResultSchema, annotations: writeAnnotations, _meta: { ...security("shots.write") }
  ...
  server.registerTool("add_review_note", {
    title: "添加审片注记",
    ...
    outputSchema: reviewNoteResultSchema, annotations: writeAnnotations, _meta: { ...security("reviews.write") }
  ...
  server.registerTool("submit_production_proposal", {
    title: "提交生产提议",
    ...
    outputSchema: proposalResultSchema, annotations: writeAnnotations, _meta: { ...security("proposals.write") }
  ...
  server.registerTool("revise_production_proposal", {
    title: "修订生产提议",
    ...
    outputSchema: revisedProposalResultSchema, annotations: writeAnnotations, _meta: { ...security("proposals.write") }
  ...
  server.registerTool("close_production_proposal", {
    title: "关闭生产提议",
  ...
  server.registerTool("prepare_generation_intent", {
    title: "准备生成意图",
    ...
    outputSchema: generationIntentResultSchema, annotations: writeAnnotations, _meta: { ...security("generation.prepare") }
