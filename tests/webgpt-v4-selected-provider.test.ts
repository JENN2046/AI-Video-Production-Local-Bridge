...
const stytchFixtureCapability: WebGptPredefinedPublicClientCapability = {
  provider_id: "stytch",
  client_registration: "predefined",
  authorization_endpoint: "https://authorize.fixture.stytch.example/authorize",
  authorization_endpoint_hosting: "application_hosted",
  authorization_endpoint_reachable: true,
  end_user_login_and_consent_ready: true,
...
test("selected provider capability rejects missing PKCE, public-client, audience, and scope guarantees", () => {
  ...
  const invalid: Array<Partial<WebGptPredefinedPublicClientCapability>> = [
    ...
    { authorization_endpoint_hosting: undefined as unknown as string },
    { authorization_endpoint_reachable: false },
    { authorization_endpoint_reachable: undefined as unknown as boolean },
    { end_user_login_and_consent_ready: false },
    { end_user_login_and_consent_ready: undefined as unknown as boolean },
