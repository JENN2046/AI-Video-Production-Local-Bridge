...
test("migrations 0009 through 0012 upgrade a real 0008 shape and preserve immutable evidence", () => {
...
test("migrations 0010 through 0012 upgrade an already-ledgered 0009 Grant database without checksum drift", () => {
  const db = new DatabaseSync(":memory:");
  try {
    db.exec("PRAGMA foreign_keys = ON");
