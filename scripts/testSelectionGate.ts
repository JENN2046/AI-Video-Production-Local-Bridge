...
export const REQUIRED_READONLY_APP_SUITES: ReadonlyArray<ReadonlyAppSuite> = [
  ...
  { id: "readonly-media-mp4-acceptance-fixture", path: "tests/webgpt-media-acceptance-fixture.test.ts", npm_script: "test:webgpt:media-gateway", ci_step: "Readonly media gateway contract tests", case_name: "MP4 acceptance fixture is isolated, snapshot-v4 bound, source-preserving, and low disclosure" },
