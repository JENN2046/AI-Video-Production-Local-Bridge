...
export const REQUIRED_READONLY_APP_SUITES: ReadonlyArray<ReadonlyAppSuite> = [
  ...
  { id: "readonly-apps-smoke", path: "tests/webgpt-apps-smoke.test.ts", npm_script: "smoke:webgpt:app", ci_step: "WebGPT Apps smoke", case_name: "Apps smoke discovers seven readonly tools, reads the UI resource, and renders an empty authenticated shell" }
];
