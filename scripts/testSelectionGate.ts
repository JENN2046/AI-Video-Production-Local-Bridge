...
export const REQUIRED_DIRECTOR_SUITES: ReadonlyArray<DirectorSuite> = [
  ...
  { id: "director-migration-immutability", path: "tests/director-domain-contract.test.ts", npm_script: "test:webgpt:director", ci_step: "ChatGPT Director domain tests", case_name: "migrations 0009 through 0012 upgrade a real 0008 shape and preserve immutable evidence" },
  { id: "director-currency-migration-compatibility", path: "tests/director-domain-contract.test.ts", npm_script: "test:webgpt:director", ci_step: "ChatGPT Director domain tests", case_name: "migrations 0010 through 0012 upgrade an already-ledgered 0009 Grant database without checksum drift" },
